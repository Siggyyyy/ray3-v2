...
async function fetchFootprintInfo(accessToken, missionIds) {
    for (const missionId of missionIds) {
        ...
        try {
            const res = await fetch("https://ray3-backend.onrender.com/fetch-mission-footprints", {
                method: "POST",
...
async function fetchSceneFrames(accessToken, missionId, sceneId) {
    try {
        const res = await fetch("https://ray3-backend.onrender.com/get-scene-frames", {
            method: "POST",
            headers: { "Content-Type": "application/json" },
...
async function fetchScenes(accessToken, missionIds) {
    ...
    try {
        const res = await fetch("https://ray3-backend.onrender.com/get-scenes", {
            method: "POST",
            headers: { "Content-Type": "application/json" },
...
async function fetchMissionInfo(accessToken) {
    ...
    try {
        const res = await fetch("https://ray3-backend.onrender.com/fetch-missions", {
            method: "POST",
            headers: { "Content-Type": "application/json" },
